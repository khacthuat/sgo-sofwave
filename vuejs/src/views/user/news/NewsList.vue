<template>
  ...
  <div class="flex flex-col col-12 col-lg-10 lg:pr-[30px]">
    ...
    <div class="flex align-content-center justify-between my-3 w-full">
      ...
      <div>
        <a-select
          ...
          placehoder="Sắp xếp"
        >
          <a-select-option value="normal">Thông thường</a-select-option>
          <a-select-option value="newest">Tin mới nhất</a-select-option>
          <a-select-option value="priceAsc"
            >Giá từ thấp đến cao</a-select-option
          >
          <a-select-option value="priceDesc">Giá cao đến thấp</a-select-option>
        </a-select>
      </div>
      <!-- end::Filter -->
    </div>
          ...
          <div>
            ...
            <div class="p-3 border-b-[1px]">
              ...
              <div class="mt-1">
                <h3 class="text-xl font-semibold">
                  <span class="line-clamp-2">
                    Bán nhanh nhiều biệt thự - Shophouse vinhomes, vị trí đẹp
                  </span>
                </h3>
              </div>
              <!-- end::Card Info Title -->
              ...
              <div class="mt-2 line-clamp-2">
                *Chuyên bán biệt thự, nhà phố và tất cả các sản phẩm trong dự án
                Vinhomes Grand Park - Quận 9 - Thành phố Thủ Đức
              </div>
    ...
    <div class="flex mb-5 justify-center align-items-center">
      <a-pagination v-model:current="current" :total="8000" show-less-items>
      </a-pagination>
    </div>
    <!-- end::Pagination -->
  </div>
