    ...
    <div class="flex flex-col lg:flex-row w-100">
        ...
        >
            ...
            <a-menu
                ...
                @click="handleTabChange($event.key)"
            />
            <!-- end::Tabs -->
            ...
            <div class="tab-content">
                <!-- begin::Tab Pane -->
                <div class="tab-pane fade" v-show="activeTab === 'general'">
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                >
                                    <!-- begin::Label -->
                                    <div class="required form-label">Mô tả</div>
                                    <!-- end::Label -->
                            ...
                            <div class="card-body pt-0">
                                ...
                                >
                                    <div class="col-12 col-xl-8 mb-3 mb-xl-0">
                                        <!-- begin::Label -->
                                        <div class="form-label">Mức giá</div>
                                        <!-- end::Label -->
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <p class="ant-upload-hint">
                                                Hỗ trợ tải lên nhiều file cùng
                                                lúc
                                            </p>
                                        </a-upload-dragger>
                                    </div>
                ...
                <!-- begin::Tab Pane -->
                <div class="tab-pane fade" v-show="activeTab === 'comments'">
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        <!-- begin::Reviews -->
                        <div class="card card-flush py-4">
                            <div class="card-header">
